...
public class agentController {
	...
	public RedirectView creerAgent(Model model,
			@ModelAttribute("nvAgent") Agent ag,
			@RequestParam(name="idagence" , defaultValue="1") Long idAgence,
		...
		return new RedirectView("/agent");
	}
	
	@GetMapping("/deletAgent")
	public RedirectView deletAgent(Model model,
	...
	public RedirectView signalerAgent(Model model,
			@RequestParam(name="idagent") Long idAgent) {
	...
	public RedirectView saveAgent(Model model,
